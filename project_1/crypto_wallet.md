...
| 3   | Functional     | login | 1. Use login function. 2. Input different username/password than written in register function. 3. Input same username and password as written in register function.                                                                                        | 1. With a wrong username/password error message will be displayed and program will close. 2. With a correct username and password program conitues and succes message will be displayed.                                                                                                                                                                                                                                          |
